...
import electron_app from "./electron_app.png";
...
function App() {
  const [pages] = useState([
    {
      ...
      image: logo,
      content:
        "Hello! My name is Jordan and I'm based out of Utah! I've been working In web development and all things coding for about a year now. I love creating things from nothing and sharing it with others. I'm currently working for Infosys as a Jr Tech Associate.",
    },
    {
      title: "Projects",
      image: projectsImg,
  ...
  const [projects] = useState([
    {
      liveSite: "https://github.com/imjord/Favorite-Games-Launcher",
      skills: "Javascript, Node.js, Electron.js",
      title: "Imjord Game Launcher",
      image: electron_app,
    },
    {
